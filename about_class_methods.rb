...
class AboutClassMethods < EdgeCase::Koan
  ...
  def test_other_objects_are_not_affected_by_these_singleton_methods 
	  #singleton is so named, because it applys to a single instance only
    fido = Dog.new
    rover = Dog.new
    def fido.wag
      :fidos_wag
  ...
  #   end
  #
  # Which do you prefer and why? The first method looks more elegant, but it is not as obvious.
  # Are there times you might prefer one over the other? The first is nice for simple code, but with
  # a lot of methods in the same class, the second would be more explicit and therefore easier to follow.
